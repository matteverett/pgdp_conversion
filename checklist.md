...
./make_project.py
```
* [ ] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID623988b554ad9#project-comments)
* [ ] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=76498) and read all posts
* [ ] Open `conversion-utf8.txt` in Guiguts
...
* [ ] Use `File → Save a Copy As` to make `conversion.html`
...
* [ ] Re-open `conversion-utf8.txt` (if not still open).
...
### Generate the HTML
* [ ] Open `conversion.html` that was saved previously.
...
* [ ] `make sr`
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID623988b554ad9), select SR time period, upload `conversion-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `conversion-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID623988b554ad9))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID623988b554ad9)
